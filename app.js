...
const resList=[
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-02-01 22:59:00",
          "opened": true
        },
        "badges": {
          "textExtendedBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-02-02 03:45:00",
          "opened": true
        },
        "badges": {
    ...
    return(
        <div className="res-card" style={{backgroundColor:"#f0f0f0"}}>   
            <img className="res-logo" 
                ...
                resData.info.cloudinaryImageId} height={150} width={200}>
            </img>   
    ...
    return(
        <div className="body">
            ...
            <div className="resto-container">
                {
                    resList.map((restraunt) => (<RestaurantCard resData = {restraunt}/>))
                }
            </div>
        </div>
    );
